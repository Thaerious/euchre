...
from euchre.card import Deck
from euchre.card.Card import losing_card, winning_card
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "♠",
            "K♦",
        ),  # Lead suit beats off-suit, even if ranks are the same
